...
<!--&lt;!&ndash;    <div class="text-center mb-16">&ndash;&gt;-->
<!--&lt;!&ndash;      <h2 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">&ndash;&gt;-->
<!--&lt;!&ndash;        Nuestras <span class="text-blue-600">Categorías</span>&ndash;&gt;-->
<!--&lt;!&ndash;      </h2>&ndash;&gt;-->
<!--&lt;!&ndash;      <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">&ndash;&gt;-->
<!--&lt;!&ndash;        Explora nuestra amplia gama de productos para construcción y decoración.&ndash;&gt;-->
<!--&lt;!&ndash;        Encuentra todo lo que necesitas para tu proyecto.&ndash;&gt;-->
<!--&lt;!&ndash;      </p>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->

<!--&lt;!&ndash;    &lt;!&ndash; Categories grid &ndash;&gt;&ndash;&gt;-->
<!--&lt;!&ndash;    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">&ndash;&gt;-->
<!--&lt;!&ndash;      <ProductCard&ndash;&gt;-->
<!--&lt;!&ndash;          v-for="category in categories"&ndash;&gt;-->
<!--&lt;!&ndash;          :key="category.id"&ndash;&gt;-->
<!--&lt;!&ndash;          :category="category"&ndash;&gt;-->
<!--&lt;!&ndash;          :currency="currency"&ndash;&gt;-->
<!--&lt;!&ndash;          @select="handleCategorySelect"&ndash;&gt;-->
<!--&lt;!&ndash;          class="category-card"&ndash;&gt;-->
<!--&lt;!&ndash;          :class="[&ndash;&gt;-->
<!--&lt;!&ndash;          category.featured ? 'xl:col-span-2' : '',&ndash;&gt;-->
<!--&lt;!&ndash;          category.size === 'large' ? 'lg:col-span-2' : ''&ndash;&gt;-->
<!--&lt;!&ndash;        ]"&ndash;&gt;-->
<!--&lt;!&ndash;      />&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->

<!--&lt;!&ndash;    &lt;!&ndash; View all categories button &ndash;&gt;&ndash;&gt;-->
<!--&lt;!&ndash;    <div class="text-center mt-16">&ndash;&gt;-->
<!--&lt;!&ndash;      <button&ndash;&gt;-->
<!--&lt;!&ndash;          @click="$emit('viewAll')"&ndash;&gt;-->
<!--&lt;!&ndash;          class="inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"&ndash;&gt;-->
<!--&lt;!&ndash;      >&ndash;&gt;-->
<!--&lt;!&ndash;        <span class="text-lg">Ver todas las categorías</span>&ndash;&gt;-->
<!--&lt;!&ndash;        <ArrowRightIcon class="w-6 h-6" />&ndash;&gt;-->
<!--&lt;!&ndash;      </button>&ndash;&gt;-->
<!--&lt;!&ndash;    </div>&ndash;&gt;-->

<!--&lt;!&ndash;    &lt;!&ndash; Statistics &ndash;&gt;&ndash;&gt;-->
<!--&lt;!&ndash;    <div class="mt-20 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 rounded-3xl p-12">&ndash;&gt;-->
<!--&lt;!&ndash;      <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">&ndash;&gt;-->
<!--&lt;!&ndash;        <div&ndash;&gt;-->
<!--&lt;!&ndash;            v-for="stat in statistics"&ndash;&gt;-->
<!--&lt;!&ndash;            :key="stat.label"&ndash;&gt;-->
<!--&lt;!&ndash;            class="text-center"&ndash;&gt;-->
<!--&lt;!&ndash;        >&ndash;&gt;-->
<!--&lt;!&ndash;          <div class="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">&ndash;&gt;-->
<!--&lt;!&ndash;            {{ stat.value }}&ndash;&gt;-->
<!--&lt;!&ndash;          </div>&ndash;&gt;-->
<!--&lt;!&ndash;          <div class="text-gray-600 dark:text-gray-400 font-medium">&ndash;&gt;-->
