...
class CotizacionService {
    STORAGE_KEY = 'cotizacion_bcu';
    API_URL = 'https://ceramicascentral.netlify.app/.netlify/functions/cotizacion-bcu';
    cotizacion = null;
    constructor() {
    ...
    cotizacionValida() {
        ...
        const horasTranscurridas = (Date.now() - new Date(this.cotizacion.ultimaActualizacion).getTime()) / (1000 * 60 * 60);
     ...
     */
    async convertirAPesos(precioUSD) {
...
export function useCotizacion() {
    return {
        ...
        convertirAPesos: (precioUSD) => cotizacionService.convertirAPesos(precioUSD),
